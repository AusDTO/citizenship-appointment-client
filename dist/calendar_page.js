...
/***/ function(module, exports) {
	...
	mod.addClassToElements = function (selectorString, className) {
	...
	mod.clearSelection = function () {
	  mod.hideElementsBySelectors('.SelectionConfirmation');
	  var elements = document.querySelectorAll('.SelectionConfirmationCell');
