...
/***/ function(module, exports, __webpack_require__) {
	...
	var Datetime = function () {
	  ...
	  _createClass(Datetime, [{
	    ...
	    key: 'isSameYearAndMonth',
	    value: function isSameYearAndMonth(that) {
	      return this.toMonthString() === that.toMonthString();
	    }
	  }, {
	    key: 'isSameDay',
	    value: function isSameDay(that) {
	...
	['set', 'add', 'subtract', 'startOf', 'endOf'].forEach(function (member) {
	  Datetime.prototype[member] = function () {
	    var _asMoment;
	
	    return new Datetime((_asMoment = this.asMoment())[member].apply(_asMoment, arguments));
	  };
	});
	
	['isBefore', 'isAfter', 'isSameOrBefore', 'isSameOrAfter'].forEach(function (member) {
	  Datetime.prototype[member] = function (that) {
	    return this.datetime[member](that.asMoment());
	  };
	});
	
	['toISOString'].forEach(function (member) {
	  Datetime.prototype[member] = function () {
	...
	['date', 'week', 'month', 'year', 'format'].forEach(function (member) {
	  Datetime.prototype[member] = function () {
	    if (arguments.length > 0) {
	      ...
	      return new Datetime((_asMoment2 = this.asMoment())[member].apply(_asMoment2, arguments));
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (bookableMonths, availableDates, todayDate) {
	  ...
	  try {
	    for (var _iterator = bookableMonths[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var month = _step.value;
	
	      var date = month.startOf('month').startOf('week');
	      ...
	      var prevMonth = month.subtract(1, 'months');
	      var nextMonth = month.add(1, 'months');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (datetimeString) {
	  var appointment = datetime(datetimeString);
	  dom.hideElementsBySelectors('.SelectionConfirmation');
	  var selectionData = {
	  ...
	  var renderedSelectionConfirmationHtml = selection_confirmation_template.render(selectionData);
...
/***/ }
/******/ ]);
//# sourceMappingURL=calendar_page.js.map