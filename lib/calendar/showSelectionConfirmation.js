...
module.exports = (datetimeString) => {
  ...
  let cellTabIndex = document.querySelector(`.AppointmentTimes-list--item.datetime-${appointment.toDateTimeClassString()} a`);

  let tabIndex = ((typeof cellTabIndex !== "undefined") && cellTabIndex !== null) ? cellTabIndex.tabIndex : "";
